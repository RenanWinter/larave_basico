...
<div id="event-create-container" class="col-md-6 offset-md-3">
    ...
    <form action="/events" method="POST" enctype="multipart/form-data">
        ...
        <div id="facilities" class="form-group">
            ...
            <div class="form-group">
                <input type="checkbox" name="items[]" value="Mesas" id="mesas">
                <label for="mesas">Mesas</label>
            </div>

            <div class="form-group">
                <input type="checkbox" name="items[]" value="Cerveja Gratis" id="cerveja">
                <label for="cerveja">Cerveja Gratis</label>
            </div>

            <div class="form-group">
                <input type="checkbox" name="items[]" value="Open Food" id="food">
